...
1.  Test it on **10+ real** pieces of your own scattered information.
...
## — Auto-Link Related Notes (Connect the Dots)
...
## — Graph Data Model (Give It a Shape)
...
## — Interactive Graph (The Brain Comes Alive)
...
## — Ask Your Brain (Natural Language Search)
...
## — UI, Deployment, Public URL (Give It a Face)
...
├── build\_graph.py # Week 3: nodes/edges → graph.json
...
5.  build\_graph.py → JSON nodes/edges (Week 3.1)
